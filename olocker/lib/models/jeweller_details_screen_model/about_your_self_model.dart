...
AboutYourSelfModel aboutYourSelfModelFromJson(String str) =>
    AboutYourSelfModel.fromJson(json.decode(str));
...
class AboutYourSelfModel {
  ...
  factory AboutYourSelfModel.fromJson(Map<String, dynamic> json) =>
      AboutYourSelfModel(
