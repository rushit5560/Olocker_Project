...
//
//     final announcementOfferModel = announcementOfferModelFromJson(jsonString);
...
class AnnouncementOfferModel {
  ...
  factory AnnouncementOfferModel.fromJson(Map<String, dynamic> json) =>
      AnnouncementOfferModel(
        ...
        data: List<GetPushOfferItem>.from(
            (json["data"] ?? []).map((x) => GetPushOfferItem.fromJson(x))),
      );
}
...
class GetPushOfferItem {
  ...
  factory GetPushOfferItem.fromJson(Map<String, dynamic> json) =>
      GetPushOfferItem(
        srNo: (json["srNo"] ?? 0).toString(),
        name: json["name"] ?? "",
        pushSortOrder: (json["pushSortOrder"] ?? 0).toString(),
        imageurl: json["imageurl"] ?? "",
        isClickable: false,
      );
}
