...
class OfflineDealsDetailsScreenController extends GetxController {
  OffLineDeal offLineDealDetails = Get.arguments;
  Size size = Get.size;
  ...
  Future<void> addOnlineDealInFavouriteFunction() async {
    ...
    try {
      var bodyData = {
        ...
        "DealId": offLineDealDetails.srNo,
      ...
      if (isSuccessStatus.value) {
        ...
        offLineDealDetails.isFavoriteDeal = true;
        log('onLineDealDetails.isFavoriteDeal : ${offLineDealDetails.isFavoriteDeal}');
  ...
  void onInit() {
    ...
    if (offLineDealDetails.isFavoriteDeal == true) {
      multiStateButtonController.setButtonState = activateSuccess;
    }
  }
}
