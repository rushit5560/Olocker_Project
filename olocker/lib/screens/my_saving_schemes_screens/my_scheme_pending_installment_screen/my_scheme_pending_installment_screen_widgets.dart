...
import '../../../controllers/my_saving_schemes_screens_controllers/my_scheme_pending_installment_screen_controller.dart';

class HeaderModule extends StatelessWidget {
  HeaderModule({Key? key}) : super(key: key);
  final screenController =
      Get.find<MySchemePendingInstallmentScreenController>();
