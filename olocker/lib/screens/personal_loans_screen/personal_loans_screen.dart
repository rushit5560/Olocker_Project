        ...
        : SingleChildScrollView(
          child: Column(
            children: [
              ...
              NumberStepper(
                numbers: const [1, 2, 3],
                activeStep: personalLoansScreenController.currentStep.value,
                ...
                lineLength: personalLoansScreenController.size.width * 0.20,
              ...
              Container(
                decoration: BoxDecoration(
                  color: personalLoansScreenController.currentStep.value == 1 ?  null : AppColors.whiteColor,
                  borderRadius: BorderRadius.circular(10),
                ),
                child: personalLoansScreenController.currentStep.value == 0
                ? StepOneFormModule()
